...
const Color mainColor = Color(0xFF231E72);

/// <--- Dark theme Colors ---> ///

/// app button's color
const  Color buttonColor = Color(0xFF231E72);
const Color disableBtnColor = Colors.grey;
...
const Color bottomSheetBgColor  = Colors.white;
const Color cardBgColor  = Colors.amber;
...
const imageBackgroundColor = Colors.grey;
...
Color splashScreenColor = mainColor;
...
/// text colors
const Color normalTextColor = Colors.black;

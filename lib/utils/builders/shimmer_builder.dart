...
class _ShimmerBuilderState extends State<ShimmerBuilder> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(ShimmerBuilder oldWidget) {
    if (widget.enabled) {
      _controller.forward();
    } else {
      _controller.stop();
